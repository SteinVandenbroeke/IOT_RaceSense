		...
		<main class="flex-1 overflow-y-auto">
			...
			{#if session.isActive}
				<section
					role="alert"
					aria-live="polite"
					class="bg-zinc-900 border-b border-zinc-800 px-4 py-3 sm:px-6 shadow-md"
				>
						...
						{#each Object.entries(globalSocket.cars) as [idStr, carData]}
							...
							>
								<div class="flex justify-between w-full items-center mb-1.5">
									...
									<!-- Tiny green dot indicates this car has recently sent data -->
									<span class="w-1.5 h-1.5 rounded-full bg-emerald-500 shadow-[0_0_4px_#10b981]"></span>
								</div>

								<!-- Mini HUD data for the carousel -->
